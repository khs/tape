...
These YAMLs are generated by pipelines/_scaffold_eia_state_energy.py
...
this one needs no live provider call. The meaningful risk is a
scaffolder bug that pairs a fuel code with the wrong fuel word in the
