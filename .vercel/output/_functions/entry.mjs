...
import { c as createExports, s as serverEntrypointModule } from './chunks/_@astrojs-ssr-adapter_zTeD4z0v.mjs';
import { manifest } from './manifest_D64OrAJA.mjs';
...
const _args = {
    "middlewareSecret": "a07d4059-8247-4266-90dd-3471075a9e2e",
